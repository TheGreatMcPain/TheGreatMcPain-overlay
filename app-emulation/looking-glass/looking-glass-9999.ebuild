...
pkg_postinst() {
	if use host; then
		einfo
		einfo "Unlike the non-live versions host windows binaries aren't bundled."
		einfo
		einfo "Please download the host binaries from the 'Bleeding Edge' section."
		einfo "Here: https://looking-glass.io/downloads"
		einfo
	fi
}
