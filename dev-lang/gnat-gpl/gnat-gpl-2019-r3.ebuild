...
BTSTRP_ARM=gnat-gpl-2017-arm-linux-bin
...
GCC_TARBALL_SRC_URI="
	...
	bootstrap? (
		...
		arm? (
			https://community.download.adacore.com/v1/71b5830d0242dfeb294d8895960f969bbc5c2417?filename=gnat-gpl-2017-arm-elf-linux-bin.tar.gz ->
			${BTSTRP_ARM}.tar.gz
		)
	)"
