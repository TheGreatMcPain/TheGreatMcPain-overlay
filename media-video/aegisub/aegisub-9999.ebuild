...
inherit autotools l10n lua-single wxwidgets xdg-utils

DESCRIPTION="Advanced subtitle editor (wangqr fork)"
HOMEPAGE="http://www.aegisub.org/ https://github.com/wangqr/Aegisub"

if ver_test -eq "9999"; then
	inherit git-r3
	EGIT_REPO_URI="https://github.com/wangqr/Aegisub.git"
