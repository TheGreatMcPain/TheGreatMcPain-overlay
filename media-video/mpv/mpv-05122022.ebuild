...
inherit flag-o-matic lua-single meson optfeature pax-utils python-single-r1 xdg git-r3

EGIT_REPO_URI="https://github.com/mpv-player/mpv.git"
EGIT_COMMIT="25b66256d7ff48254b2055a066e29f260414112f"
KEYWORDS="~alpha ~amd64 ~arm ~arm64 ~hppa ~loong ~ppc ~ppc64 ~riscv ~x86 ~amd64-linux"

DESCRIPTION="Media player for the command line (HDR DRM patches)"
...
PATCHES=(
	"${FILESDIR}/0000-vo_gpu_next-compatibility-with-libplacebo_v6.265.patch"
	"${FILESDIR}/0001-video_out_gpu-add_colorspace_hint_to_ra_swapchain_fns.patch"
	"${FILESDIR}/0002-context_drm_egl-add_colorspace_hints_swapchain_function.patch"
	"${FILESDIR}/0003-drm-add_--drm-hdr-metadata_optopn-OLD_KNOWN_WORKING.patch"
)
