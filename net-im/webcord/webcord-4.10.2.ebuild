...
NODE_MODULES_SRC_URI="
	...
	https://registry.npmjs.org/deepmerge-ts/-/deepmerge-ts-7.0.3.tgz -> webcord-dep--deepmerge-ts-7.0.3.tgz
	https://registry.npmjs.org/dompurify/-/dompurify-3.1.6.tgz -> webcord-dep--dompurify-3.1.6.tgz
	...
	https://registry.npmjs.org/marked/-/marked-13.0.2.tgz -> webcord-dep--marked-13.0.2.tgz
	https://registry.npmjs.org/marked-gfm-heading-id/-/marked-gfm-heading-id-4.0.0.tgz -> webcord-dep--marked-gfm-heading-id-4.0.0.tgz
	https://registry.npmjs.org/marked-highlight/-/marked-highlight-2.1.3.tgz -> webcord-dep--marked-highlight-2.1.3.tgz
	...
	https://registry.npmjs.org/tslib/-/tslib-2.6.3.tgz -> webcord-dep--tslib-2.6.3.tgz
...
src_install() {
	...
	echo "#!/bin/sh" > "webcord"
	echo "electron-32 '/usr/lib/webcord' \"\$@\"" >> "webcord"
	dobin "webcord"
}
